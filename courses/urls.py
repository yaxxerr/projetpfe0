...
from django.urls import path
from .views import ResourceListCreateView, AccessRequestListCreateView, SpecialityHierarchyView
...
urlpatterns = [
    ...
    path('hierarchy/', SpecialityHierarchyView.as_view(), name='course-hierarchy'),
]