...
from . import views
from .views import user_list, user_detail, register_user, LoginView, CurrentUserView, UserUpdateView, MyProfileView, StudentSearchView, ProfessorSearchView, UserSearchView, MyModulesView, UpdateMyProfileView
